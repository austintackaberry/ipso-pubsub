...
export const isScheduleRequestPromptTemplate = `Email: hey, how are you? just reaching out to see if you're interested in buying my product
This email warrants a response that includes offering times to meet (yes or no): no
...
export const toStructuredJsonPromptTemplate = `Question: Today is Monday January 23, 2023. Want to get coffee some time next week? I'm busy on Tuesday.
