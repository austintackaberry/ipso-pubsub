...
exports.getEmailToSendPrompt = exports.toStructuredJsonPromptTemplate = exports.isScheduleRequestPromptTemplate = exports.getLangPrompt = exports.getPrompt = void 0;
...
exports.isScheduleRequestPromptTemplate = `Email: hey, how are you? just reaching out to see if you're interested in buying my product
This email warrants a response that includes offering times to meet (yes or no): no
...
Email: {{email}}
This email warrants a response that includes offering times to meet (yes or no):`;
exports.toStructuredJsonPromptTemplate = `Question: Today is Monday January 23, 2023. Want to get coffee some time next week? I'm busy on Tuesday.
...
Question: Today is {{date}}. {{text}}

`;
const getEmailToSendPrompt = (d, formattedDates, emailThread) => {
    return `Today is Wednesday November 15, 2023.
---Email thread starts here---
Harry: Hey do you want to grab coffee sometime this week?
Austin: Yeah sure. When are you free?
...
I'm available tomorrow between 8AM and 9AM. Let me know if that works for you.
---Austin's response ends here---

Today is Monday March 6, 2023.
---Email thread starts here---
Harry: Hey Austin, want to grab drinks next week?
Austin: Yeah, let's do it. I should be free Tuesday or Wednesday
Harry: How about Tuesday?
---Email thread ends here---
Austin is available these times: Tuesday March 14, 2023 7PM to 10PM
---Austin's response starts here---
Hey Harry,
...
exports.getEmailToSendPrompt = getEmailToSendPrompt;
